        ...
        <div className="grid w-screen h-screen grid-cols-2">
            ...
            <div className="my-auto min-h-[50vh]">
                ...
                <div className="grid grid-cols-2">
                    ...
                    <a className="text-blue-600 hover:underline" href="https://github.com/konstantinlob/gitalytics.org" target="_blank" rel="noreferrer">konstantinlob/gitalytics.org</a>
                </div>
            </div>
        </div>
        <Footer />
